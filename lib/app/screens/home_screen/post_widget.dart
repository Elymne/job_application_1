...
class PostWidget extends StatelessWidget {
  ...
  const PostWidget({super.key, required this.post, required this.profile, required this.onMore});
          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [Colors.transparent, Colors.transparent, Colors.black.withAlpha(250)],
